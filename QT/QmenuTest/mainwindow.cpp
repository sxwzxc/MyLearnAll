...
#define IPCAPP_STYLE_NVR_MENU3 "QMenu{ background: #FFFFFF; border: 2px solid blue; width: 160px;}" \
    "QMenu:pressed{ background: #E5F3FF;}" \
    "QMenu::item{ font: 12px;  color: #333333; height: 32px; width: 169px; padding-left:9px;}" \
...
#define IPCAPP_STYLE_NVR_MENU "QMenu{background:#FFFFFF;border:1px solid #CCCCCC;color:#333333;font-size:12px;}QMenu::item{height:32px;width:160px;background: #E5F3FF;padding-left:80px;}"
